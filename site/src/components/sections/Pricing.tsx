    ...
    <section id="pricing" className="border-t border-white/10">
      <div className="mx-auto max-w-6xl px-5 py-16 sm:py-20">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 lg:grid-cols-2">
          <Reveal delayMs={80}>
            <div className="rounded-[var(--radius)] border border-white/10 bg-white/5 p-7 backdrop-blur">
          ...
          <Reveal delayMs={130}>
            <div className="glow-border">
              <div className="rounded-[var(--radius)] border border-white/10 bg-white/6 p-7 backdrop-blur">
                <div className="flex items-start justify-between gap-4">
                  <div>
                  ...
                  <span className="rounded-full bg-gradient-to-b from-red-500/25 to-white/5 px-3 py-1 text-xs font-semibold text-red-200/90">
                    Best value
                  </span>
                </div>
