        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <Reveal delayMs={80}>
            <h1 className="mt-6 text-balance text-4xl font-semibold tracking-tight text-white sm:text-6xl">
              {copy.heroTitleA}{' '}
              <span className="bg-gradient-to-r from-sky-300 to-blue-600 bg-clip-text text-transparent">{copy.heroTitleB}</span>{' '}
              {copy.heroTitleC}
            </h1>
          </Reveal>

          <Reveal delayMs={140}>
            <p className="mt-5 text-pretty text-base leading-relaxed text-white/70 sm:text-lg">{copy.heroDesc}</p>
          </Reveal>
