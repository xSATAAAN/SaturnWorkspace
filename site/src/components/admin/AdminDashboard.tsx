    ...
    try {
      ...
      setError(
        message === 'same_version_already_active'
          ...
          : message === 'invalid_file_type' || message === 'invalid_file_content'
            ? 'Choose a valid update file for the selected type.'
          : message === 'file_too_large'
            ? 'The update file exceeds the allowed size.'
          : message,
      )
    } finally {
      setSaving(false)
                ...
                <div className="grid gap-3 md:grid-cols-2">
                  ...
                  <label className="grid gap-1 text-xs text-white/65">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        setOtaInstalledFile(e.currentTarget.files?.[0] || null)
                      }}
                    />
                  </label>
                  <label className="grid gap-1 text-xs text-white/65">
