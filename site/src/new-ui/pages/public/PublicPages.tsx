...
function PricingPreview({ navigate, full = false }: { navigate: Navigate; full?: boolean }) {
  ...
  const plans = [
    ...
    { name: c.monthlyName, description: c.monthlyBody, price: c.monthlyPrice, originalPrice: c.monthlyOriginalPrice, period: c.monthlyPeriod, features: [c.monthlyTrialFeature, c.featureWorkspace, c.featureProfiles, c.featureRecovery], featured: true },
