...
export function ProductionApp() {
  ...
  if (route.surface === 'auth') return <AuthProductionPages page={route.page} routeState={route.state} navigate={navigate} />
  ...
  return <PublicProductionPages page={route.page} routeState={route.state} navigate={navigate} />
}
