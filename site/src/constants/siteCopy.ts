...
const arCopy: SiteCopy = {
  ...
  features: [
    ...
    },
    {
      ...
      desc: 'اختيار وفحص بروكسي سريع من داخل الأداة، مع التحكم في الدولة والبروتوكول ومدة الثبات قبل بدء الجلسة.',
    },
  ],
  howTag: 'طريقة العمل',
  ...
  faq: [
    ...
    { q: 'ما المتصفحات المدعومة حاليًا؟', a: 'AdsPower مدعوم حاليًا، وقد تتم إضافة مزايا متصفح إضافية لبعض الاشتراكات مستقبلًا.' },
...
const enCopy: SiteCopy = {
  ...
  stats: [
    ...
    { label: 'Operators using workspace', value: '2,500+', hint: 'daily active workflows' },
  ...
  features: [
    ...
    },
    {
      ...
      desc: 'Choose and check a fast proxy from inside the tool, with country, protocol, stability, and launch-ready session controls.',
    },
  ],
  howTag: 'HOW IT WORKS',
  ...
  faq: [
    ...
    { q: 'Which browsers are supported now?', a: 'AdsPower is supported now. Additional browser capabilities may be added for selected subscriptions later.' },
