...
| PR-010 | Desktop QA Setup | Distribution QA | Current QA setup is `D:\SaturnWS\build-output\phase-c-commercial-20260713-211709\setup\SaturnWorkspace-Setup-1.1.0.exe`; size `41,477,221` bytes; SHA256 `099888CBD9B2E3364E312C8E8A60015C0A616C4D2C549D9AE2EF83098E0AC1DC`. Package parity, startup, local journeys, `72/72` UI matrix, same-version repair/install, installed runtime, and Launcher handoff pass. It is not published to OTA, GitHub Releases, or R2. Clean uninstall of this exact artifact remains consolidated Phase G manual acceptance because uninstalling the active data-bearing workstation was not safe. | Phase G acceptance |
