...
3. Configure vars/secrets:
   ...
   - `PAYMENTS_ALLOWED_ORIGIN` (public website origin allowed to create/check manual payment requests)
...
- The current clean setup uses manual payment requests only until the replacement gateway is selected.
